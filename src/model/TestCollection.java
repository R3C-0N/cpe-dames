...
public class TestCollection {
	...
	public static void main(String[] args) {
		...
		// la collection de pièes en jeu - mélange noires et blanches
		...
		* Remplissage 
		* Affichage selon l'ordre d'insertion dans collection - 5 pièes par ligne
...
//		System.out.println(getRender(pieces));
	...
	private static Collection<PieceModel> fillCollection(Collection<PieceModel> pieces) {
		...
		//	// Création des pions noirs et ajout à nouveau dans la collection de pièes
